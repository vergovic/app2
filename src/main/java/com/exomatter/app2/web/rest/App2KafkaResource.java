...
@RestController
@RequestMapping("/api/app-2-kafka")
public class App2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(App2KafkaResource.class);
    ...
    public App2KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
